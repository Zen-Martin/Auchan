...
import com.auchan.config.Configuration;
import com.auchan.config.Properties;
...
public class Page {
    ...
    public static void setCookieHandled(int cookieHandled) {
        Page.cookieHandled = cookieHandled;
    }

    private static int cookieHandled = 0;
    ...
    public static int getCookieHandled() {
